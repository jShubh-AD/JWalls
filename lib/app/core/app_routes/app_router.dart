...
import 'package:walpy/app/modules/artist/presentation/pages/portfolio.dart';
...
import 'package:walpy/app/modules/artist/data/artist_repository_impl.dart';
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (context, state){
        ...
        return BlocProvider(
          create: (context) => ArtistBloc(ArtistUseCase(ArtistRepositoryImpl()))..add(FetchArtistPhotos(args.username ?? '')),
          child: Portfolio(user: args),
        );
      },
    ),
  ],
